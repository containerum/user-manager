...
ENV GIN_MODE=release \
    ...
    CH_USER_MAIL="http" \
    CH_USER_MAIL_URL="http://192.168.88.200:7070/" \
    CH_USER_RECAPTCHA="dummy" \
    CH_USER_RECAPTCHA_KEY="recaptcha_key" \
    CH_USER_OAUTH_CLIENTS="http" \
    CH_USER_AUTH_GRPC_ADDR="192.168.88.200:1112" \
    CH_USER_WEB_API="http" \
    CH_USER_WEB_API_URL="http://192.168.88.200:5000" \
    CH_USER_RESOURCE_SERVICE="http" \
    CH_USER_RESOURCE_SERVICE_URL="http://192.168.88.200:1213" \
