...
func (db *pgDB) GetUserByBoundAccount(ctx context.Context, service umtypes.OAuthResource, accountID string) (*User, error) {
...
func (db *pgDB) GetUserBoundAccounts(ctx context.Context, user *User) (*Accounts, error) {
...
func (db *pgDB) BindAccount(ctx context.Context, user *User, service umtypes.OAuthResource, accountID string) error {
	...
	_, err := db.eLog.ExecContext(ctx, query, user.ID, accountID)
	return err
}
